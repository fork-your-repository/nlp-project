...
def most_frequent_python_word():    
    print(f'The most common word in the python category is {word_counts.python.sort_values(ascending=False).index[1]} showing up in all {word_counts.python.sort_values(ascending=False)[1]} python files')
